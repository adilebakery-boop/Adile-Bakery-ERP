...
const productionController = {
  ...
  async update(req, res) {
    try {
      const production = await productionService.update(parseInt(req.params.id), req.body, req.user);
      res.json({
        success: true,
  ...
  async getDailyProduction(req, res) {
    try {
      ...
      const productions = await productionService.getDailyProduction(parseInt(branchId), new Date(date));
      res.json({
        success: true,
